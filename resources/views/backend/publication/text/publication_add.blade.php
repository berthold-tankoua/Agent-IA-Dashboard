		...
		<div class="card">
			...
			<div class="card-body">
                ...
                <div class="row mb-6">
					...
					<div class="col-sm-10">
					<small class="fw-medium d-block">Exemple: Redige un texte attractif pour mon produit(nom, prix, contact)</small>
					<textarea rows="5" required
						id="basic-default-message"
						name="prompt[]"
						class="form-control"
						placeholder="Exemple: Redige un text attractif pour la creation de site web"
						aria-describedby="basic-icon-default-message2">
					</textarea>
					</div>
				</div>
