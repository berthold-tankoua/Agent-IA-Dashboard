	 ...
	 <form action="{{ route('publication.store') }}" method="POST" enctype="multipart/form-data">
		...
		<div class="card">
			<div class="card-header d-flex align-items-center justify-content-between">
				...
				<small class="text-body-danger float-end">Les champs marqués par (*) sont obligatoires</small>
			...
			<div class="card-body">
				<div class="row mb-6">
					...
					<div class="col-sm-10">
					<input type="text" name="title[]" class="form-control" id="basic-default-name" required placeholder="saisir le titre de la publication" />
					</div>
				</div>
                <div class="row mb-6">
                ...
                <div class="row mb-6">
					...
					<div class="col-sm-10">
						<div class="mb-4">
							<label for="formFile" class="form-label">Vous pouvez également téléverser une image de référence : elle sera utilisée comme modèle pour générer le résultat. </label>
							<input class="form-control" name="media[]" type="file" accept="image/*"  id="formFile" />
						</div>
					</div>
				</div>
                <div class="row mb-6">
					<label class="col-sm-2 col-form-label" for="basic-default-name">Prompt <span class="text-danger">(*)</span></label>
					<div class="col-sm-10">
					<small class="fw-medium d-block">Exemple : Génère une image d'un chat jouant de la guitare</small>
					<textarea rows="5" required
						id="basic-default-message"
						name="prompt[]"
						class="form-control"
						placeholder="Exemple : Génère une image d'un chat jouant de la guitare"
						aria-describedby="basic-icon-default-message2">
					</textarea>
					</div>
				</div>
                ...
                <div class="row mb-6">
					...
					<div class="col-sm-4">
						<small class="fw-medium d-block">Cocher si vous avez inserer une image simple</small>
                        <div class="form-check form-check-inline mt-4">
                          <input class="form-check-input" type="checkbox" name="modif_img[]" id="inlineCheckbox1" value="True" />
                          <label class="form-check-label" for="inlineCheckbox1">Ameliorer la qualite de L'image</label>
                        </div>
					</div>
				</div>
                @endif
			...
			<div class="card-body">
				...
				<div class="row justify-content-center">
					<div class="col-md-6">
                        ...
                        <select id="defaultSelect" required name="social_media" class="form-select">
                    ...
                    <div class="col-md-6">
                        ...
                        <label for="publish_at" class="form-label">Date de publication</label>
                          <input type="text" class="form-control" id="publish_at" name="publish_at" placeholder="Choisir date et heure" >
                        </div>
					</div>
				</div>
				<div class="row justify-content-center">
		...
		<div class="delete_extra_item_to_add" id="delete_extra_item_to_add">
			...
			<div class="card-body">
               ...
               @if ($item=='ia')
                ...
                @else
                <div class="row mb-6">
					<label class="col-sm-2 col-form-label" for="basic-default-name">Media <span class="text-danger">(*)</span></label>
					<div class="col-sm-6">
						<div class="mb-4">
							<label for="formFile" class="form-label">Inserer une Image </label>
							<input class="form-control" name="media[]" type="file" accept="image/*" required id="formFile" />
